...
--        ['Knot Thimblejack'] = 'SPECIAL_QUESTLOOP_1',
        ['Captain Kromcrush'] = 1,
        ['Mizzle the Crafty'] = 1,
--        ['Pusillin'] = 1,
    ...
    ['Silithus'] = {
        ...
        ['Hermit Ortell'] = 'SPECIAL_QUESTLOOP_1',
        ['Captain Blackanvil'] = 'SPECIAL_QUESTLOOP_1',
        ['Krug Skullsplit'] = 'SPECIAL_QUESTLOOP_1'
    },
    ['Stranglethorn Vale'] = {
        ['Jang'] = 'SPECIAL_QUESTLOOP_1'
    },
    ['Tanaris'] = {
        ['Steward of Time'] = 1
    },
            ...
            if(npcMap[loc] and npcMap[loc][npc]) then
                if(type(npcMap[loc][npc]) ~= 'string') then
                    ...
                    elseif(npcMap[loc][npc] == 'SPECIAL_RFD_B') then
                        ...
                        _G['QuestFrameCompleteButton']:Click()
                        _G['QuestFrameCompleteQuestButton']:Click()
                    elseif(npcMap[loc][npc] == 'SPECIAL_QUESTLOOP_1') then
                        -- For looping quest hand ins
